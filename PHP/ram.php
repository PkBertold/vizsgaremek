...
$result = mysqli_query($db_connect,"SELECT * FROM `ram` WHERE `barcode`='$barcode'");
...
<div>
  ...
  <label for="">Kingstone</label>
</div>
<div>
  <input type="checkbox" id="" name="">
  <label for="">Kingmax</label>
</div>
<div>
  <input type="checkbox" id="" name="">
  <label for="">G.SKill</label>
</div>
...
$result = mysqli_query($db_connect,"SELECT * FROM `ram`");			// Az összes táblából kell az adat nekünk
while($row = mysqli_fetch_assoc($result)){
		echo "<div class='card ram'>
