...
$result = mysqli_query($db_connect,"SELECT * FROM `nvme` WHERE `barcode`='$barcode'");
...
$result = mysqli_query($db_connect,"SELECT * FROM `nvme`");	// Az összes táblából kell az adat nekünk
while($row = mysqli_fetch_assoc($result)){
		echo "<div class='card nvme'>
