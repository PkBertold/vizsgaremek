...
$result = mysqli_query($db_connect,"SELECT * FROM `motherboard` WHERE `barcode`='$barcode'");
...
<head>
    ...
    <!--  ↑ Bootstrap Stylesheet ↑  -->
    <title>Webshop / Motherboard</title>
    <!--  ↓ Custom Stylesheet ↓  -->
...
$result = mysqli_query($db_connect,"SELECT * FROM `motherboard`");			// Az összes táblából kell az adat nekünk
while($row = mysqli_fetch_assoc($result)){
		echo "<div class='card alaplap'>
