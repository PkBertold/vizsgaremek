...
$result = mysqli_query($db_connect,"SELECT * FROM `vga` WHERE `barcode`='$barcode'");
...
<div>
  <input type="checkbox" id="" name="">
  <label for="">BIOSTAR</label>
</div>
<div>
  <input type="checkbox" id="" name="">
  <label for="">MSI Radeon</label>
</div>
...
$result = mysqli_query($db_connect,"SELECT * FROM `vga`");			// Az összes táblából kell az adat nekünk
