...
$result = mysqli_query($db_connect,"SELECT * FROM `hdd` WHERE `barcode`='$barcode'");
...
<div>
  <input type="checkbox" id="" name="">
  <label for="">Seagate BarraCuda</label>
</div>

<br>

<div>
  <label for="">Méret</label><br>
  <input type="checkbox" id="" name="">
  <label for="">3.5</label>
</div>
<div>
...
<div>
  <label for="">Kapacitás</label><br>
  <input type="checkbox" id="" name="">
  <label for="">2 TB</label>
</div>
<div>
  <input type="checkbox" id="" name="">
  <label for="">4 TB</label>
</div>
